...
| QA-001 | READY | Resolve the Starlette `TestClient`/httpx deprecation warning without reducing API coverage | None | Full suite passes without the warning; dependency choice documented |
